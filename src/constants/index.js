...
export const myProjects = [
  {
    title: 'Teammate - Multi-Tenant Team Collaboration SaaS',
    desc: 'Teammate is a multi-tenant SaaS platform designed to streamline team collaboration and task management. Built using the MERN stack (MongoDB, Express.js, React, Node.js), it supports isolated workspaces for different organizations, enabling teams to manage projects, assign tasks, and track progress in real time. The platform is architected for scalability with role-based access control and tenant-level data separation.',
    subdesc:
      'With Teammate, teams can collaborate efficiently through dedicated workspaces, organized task boards, and real-time project tracking.',
    href: 'https://teammate.nikverse.me',
    github: 'https://github.com/nikhilkushawaha/teammate',
    project: '/projects/teammate.png',
    texture: '/projects/teammate.png',
    logo: '/texture/teammate-logo.png',
    logoImageStyle: {
      height: "4rem",
      width: "4rem",
    },
  ...
  },
  {
    ...
    github: 'https://github.com/nikhilkushawaha/EduAi',
  ...
  },
  {
    ...
    href: 'https://finbuddy.nikverse.me',
    github: 'https://github.com/nikhilkushawaha/FinBuddy.git',
  ...
  },
  {
    ...
    github: 'https://github.com/nikhilkushawaha/NIL-AI-Intigrated-Assistant',
